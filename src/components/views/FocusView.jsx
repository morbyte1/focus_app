...
import { Play, Pause, RotateCcw, Coffee, CheckCircle, Plus, Clock, Trash2, Watch, CornerDownRight, AlertTriangle, BookOpen } from 'lucide-react';
...
export const FocusView = () => {
  ...
  // NOVAS FLAGS COMPUTADAS: Identificam se a matéria selecionada é Cursinho
  ...
  // EFEITO: Auto-preenche 160 minutos no registro manual se for Cursinho
  useEffect(() => {
      ...
      <div className="lg:col-span-2 space-y-6">
        <Card className="flex flex-col items-center justify-center min-h-[450px] relative overflow-hidden bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 shadow-xl">
          ...
          <div className="w-full max-w-xs mb-6 z-10 text-center space-y-4">
            ...
            {/* Oculta a escolha de tópico caso a matéria seja Cursinho */}
            {!isCurrentSubCursinho && (
              <div>
          ...
          <Card className="h-full flex flex-col min-h-[300px]">
            {isCurrentSubCursinho ? (
                <div className="flex flex-col items-center justify-center h-full text-center text-zinc-400 p-6 flex-1">
                    ...
                    <p className="text-sm font-medium">As tarefas não estão disponíveis para a modalidade de Cursinho Preparatório.</p>
                </div>
            ) : (
                <>
