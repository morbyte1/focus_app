      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="h-fit">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div><label className="text-xs text-gray-500 font-bold uppercase">Erro</label><textarea required className="w-full mt-1 bg-[#0F0F12] border border-gray-700 rounded-lg p-3 text-sm text-white outline-none h-20" placeholder="Diga o que você estudou durante a sessão e explique brevemente o assunto" value={desc} onChange={e=>setDesc(e.target.value)}/></div>
